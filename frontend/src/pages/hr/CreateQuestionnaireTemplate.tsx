...
import { Plus, GripVertical, Edit2, Copy, Trash2, X, Info } from 'lucide-react';
      ...
      <div className="bg-white rounded-lg border border-slate-200 shadow-sm overflow-hidden mb-6">
        <div className="p-8">
          <div className="space-y-6">
            <div>
              <label className="block text-[11px] font-bold text-slate-600 mb-2 uppercase tracking-wide">問卷名稱 (QUESTIONNAIRE NAME)</label>
              <input 
                type="text" 
      ...
      <div className="bg-white rounded-lg border border-slate-200 shadow-sm overflow-hidden mb-6">
        ...
        <div className="p-4 bg-white border-t border-slate-200 flex justify-between items-center bg-slate-50">
           ...
           <button 
             ...
             className="px-6 flex items-center py-2 bg-[#0B2544] text-white rounded font-bold text-sm hover:bg-[#13335A] transition-colors shadow-sm focus:ring-2 focus:ring-offset-2 focus:ring-[#0B2544]"
           >
             儲存問卷
           </button>
        </div>
