...
import { User, LineChart, FileWarning, Target, Bell, Settings, HelpCircle, ChevronDown, ChevronRight, LogOut, Users, Calendar, ClipboardList, FileText, Menu } from 'lucide-react';
