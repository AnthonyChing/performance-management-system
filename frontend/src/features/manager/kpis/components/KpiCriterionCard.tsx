import { Target, Edit3, Trash2, Percent } from 'lucide-react';
...
export default function KpiCriterionCard({
  kpi,
  employeeName,
  onEdit,
  onDelete,
}: KpiCriterionCardProps) {
  ...
  return (
    <div className="bg-white rounded-xl border border-slate-200 shadow-sm hover:shadow-md hover:border-slate-300 transition-all duration-200 group">
      ...
      <div className="mx-5 mt-3 mb-2 p-3 bg-slate-50 rounded-lg border border-slate-100">
        <div>
