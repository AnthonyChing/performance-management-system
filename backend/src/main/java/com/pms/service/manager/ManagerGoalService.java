...
public interface ManagerGoalService {
    ...
    ManagerGoalResponseDTO createGoal(
            UUID managerId, UUID subordinateId, ManagerGoalCreateRequestDTO request);

    ManagerGoalResponseDTO patchGoal(
            UUID managerId, UUID subordinateId, UUID goalId, ManagerGoalPatchRequestDTO request);
