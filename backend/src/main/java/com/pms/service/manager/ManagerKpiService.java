...
public interface ManagerKpiService {
    ...
    ManagerKpiResponseDTO createKpi(UUID managerId, UUID subordinateId, ManagerKpiCreateRequestDTO request);

    ManagerKpiResponseDTO patchKpi(UUID managerId, UUID subordinateId, UUID kpiId, ManagerKpiPatchRequestDTO request);
