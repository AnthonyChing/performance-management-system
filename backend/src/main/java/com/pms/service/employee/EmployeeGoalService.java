...
public interface EmployeeGoalService {
    ...
    HistoricalGoalsResponseDTO getHistoricalGoals(UUID userId, Integer page, Integer pageSize, String q, String cycleId);
    ...
    GoalProgressUpdateResponseDTO updateGoalProgress(UUID userId, String goalId, GoalProgressUpdateRequestDTO request);
