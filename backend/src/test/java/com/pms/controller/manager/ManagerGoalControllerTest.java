...
class ManagerGoalControllerTest {
    ...
    void createGoal_forNonSubordinate_returns403() {
        ...
        given().contentType("application/json")
                .body(body)
                .when()
                .post("/" + NON_SUBORDINATE_USER_ID + "/goals")
                .then()
                .statusCode(403)
    ...
    void createGoal_forNonExistentUser_returns404() {
        ...
        given().contentType("application/json")
                .body(body)
                .when()
                .post("/00000000-0000-0000-0000-000000000000/goals")
                .then()
                .statusCode(404)
    ...
    void listGoals_withStatusFilter_returnsFilteredGoals() {
        given().queryParam("status", "in_progress")
                .when()
                .get("/" + USER_ID + "/goals")
                .then()
                .statusCode(200)
    ...
    void listGoals_forNonSubordinate_returns403() {
        given().when()
                .get("/" + NON_SUBORDINATE_USER_ID + "/goals")
                .then()
                .statusCode(403)
                .body("error.code", equalTo("FORBIDDEN"));
    }
    ...
    void listGoals_forNonExistentUser_returns404() {
        given().when()
                .get("/00000000-0000-0000-0000-000000000000/goals")
                .then()
                .statusCode(404)
                .body("error.code", equalTo("SUBORDINATE_NOT_FOUND"));
    }
    ...
    void reviewGoal_whenGoalNotFound_returns404() {
        ...
        given().contentType("application/json")
                .body(body)
                .when()
                .patch("/" + USER_ID + "/goals/00000000-0000-0000-0000-000000000000")
                .then()
                .statusCode(404)
    ...
    void reviewGoal_whenCycleLocked_returns409() {
        ...
        given().contentType("application/json")
                .body(body)
                .when()
                .patch("/" + USER_ID + "/goals/" + LOCKED_GOAL_ID)
                .then()
                .statusCode(409)
