...
class HrAuditLogControllerTest {
    ...
    void listAuditLogs_withFilters_returnsMatchingAuditLog() {
        given()
                .queryParam("action", "cycle.create")
    ...
    void listAuditLogs_withEmployeeRole_returns403() {
        String employeeToken = jwtUtil.generateToken(
                UUID.fromString("00000000-0000-0000-0000-0000000000c1"), List.of("employee"));
        RequestSpecification employeeSpec = new RequestSpecBuilder()
                .setPort(port)
                .setBasePath("/api/v1/hr")
