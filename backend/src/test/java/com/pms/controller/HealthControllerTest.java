 ...
 *
 * <ol>
 *   <li>Write the test first (Red)
 *   <li>Implement the endpoint (Green)
 *   <li>Refactor
 * </ol>
 *
...
class HealthControllerTest {
    ...
    void setUp() {
        ...
        RestAssured.requestSpecification =
                new RequestSpecBuilder().setPort(port).setBasePath("/api/v1").build();
    }
